class AddCaptchaToStudyFinderSystemInfos < ActiveRecord::Migration
  def up
	  ...
	  execute "ALTER TABLE study_finder_system_infos ADD captcha #{type} NOT NULL DEFAULT #{default};"
	end

	def down
	  execute "ALTER TABLE study_finder_system_infos DROP COLUMN captcha;"
	end
end
