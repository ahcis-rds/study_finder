...
ActiveRecord::Schema.define(version: 20150513193450) do

  # These are extensions that must be enabled in order to support this database
  enable_extension "plpgsql"

  create_table "study_finder_condition_groups", force: true do |t|
    t.integer  "group_id"
  ...
  create_table "study_finder_conditions", force: true do |t|
    t.string   "condition",  limit: 1000
    t.datetime "created_at"
    t.datetime "updated_at"
  end

  create_table "study_finder_groups", force: true do |t|
    t.string   "group_name"
    t.datetime "created_at"
    t.datetime "updated_at"
  end
  ...
  create_table "study_finder_parsers", force: true do |t|
    t.string   "name"
    t.string   "klass"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "study_finder_subgroups", force: true do |t|
    t.string   "name"
    t.integer  "group_id"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "study_finder_system_infos", force: true do |t|
    t.string   "initials"
  ...
  create_table "study_finder_trial_conditions", force: true do |t|
    t.integer  "trial_id"
    t.integer  "condition_id"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "study_finder_trial_keywords", force: true do |t|
    t.integer  "trial_id"
    t.string   "keyword"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "study_finder_trial_locations", force: true do |t|
    t.integer  "trial_id"
  ...
  create_table "study_finder_trials", force: true do |t|
    t.string   "system_id"
  ...
  create_table "study_finder_users", force: true do |t|
