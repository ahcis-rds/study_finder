...
SimpleForm.setup do |config|
  ...
  config.wrappers :vertical_form, tag: 'div', class: 'form-group', error_class: 'is-invalid' do |b|
    ...
    b.use :error, wrap_with: { tag: 'span', class: 'invalid-feedback d-block' }
  ...
  config.wrappers :horizontal_form, tag: 'div', class: 'form-group', error_class: 'is-invalid' do |b|
    b.use :html5
    b.use :placeholder
    b.optional :maxlength
    b.optional :pattern
    ...
    b.wrapper tag: 'div', class: 'col-sm-9' do |ba|
      ...
      ba.use :error, wrap_with: { tag: 'span', class: 'invalid-feedback d-block' }
  ...
  config.wrappers :horizontal_boolean, tag: 'div', class: 'form-group', error_class: 'is-invalid' do |b|
    ...
    b.wrapper tag: 'div', class: 'offset-sm-3 col-sm-9' do |wr|
      ...
      wr.use :error, wrap_with: { tag: 'span', class: 'invalid-feedback d-block' }
